  ...
  class QuickAddDrawer extends SideDrawer {
    ...
    async open(opener) {
      ...
      if (response.ok) {
        ...
        this.productEl = tmpl.content.querySelector(
          ".cc-main-product .js-product"
        );
    ...
    updateContent() {
      console.log(this);
      console.log(this.getElementHtml);
      ...
      this.content.innerHTML = `
          ...
          <div class="quick-add-info__details">
            ...
            <div class="product-title">
              <a class="h6 js-prod-link" href="${this.productUrl}">
                ${this.getElementHtml(".desktop_product_title")}
              </a>
            </div>
            ${weightElem}
            <hr>
            <div class="product-price">
              ${this.getElementHtml(".desktop-product-price")}
            </div>
            <div class="product-info__discount_tags">
              ${this.getElementHtml(".product-info__discount_tags")}
            </div>
        ...
        <div class="product-options">
          ${this.getElementHtml(
            ".product-options",
            ".custom-option:not(.quick-add-hidden)"
          )}
        </div>
